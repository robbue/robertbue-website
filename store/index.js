	...
	return new Vuex.Store({
		...
		mutations: {
			...
			showingPreloader (state) {
				state.preloader = 'showing';
			},
			hidingPreloader (state) {
				state.preloader = 'hiding';
			},
			hiddenPreloader (state) {
				state.preloader = 'hidden';
			},
			visiblePreloader (state) {
		...
		actions: {
			...
			hidePreloader (context) {
				context.commit('hidingPreloader');
			},
			hiddenPreloader (context) {
				context.commit('hiddenPreloader');
			}
		}
	});
};
